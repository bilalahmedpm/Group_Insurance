...
class CreateEmployeeDocumentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('employee_documents', function (Blueprint $table) {
            ...
            $table->string('beneficiary_cnic1_img')->nullable();              //Death Case $ Death After Retirement  (required) one beneficiary
            $table->string('beneficiary_cnic2_img')->nullable();              //Death Case $ Death After Retirement  (required) in case of 2 beneficiaries
            $table->string('employee_pension_sheet_img')->nullable();         //self Case (required)
            $table->string('beneficiary_pension_sheet1_img')->nullable();     //Death $ Death After Retirement  (required) in case of 1 beneficiary
            $table->string('beneficiary_pension_sheet2_img')->nullable();     //Death $ Death After Retirement  (required) in case of 2 beneficiaries both sheet 1 and sheet 2 required
