...
class CreateEmployeesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            $table->string('status')->nullable();      //1 active //2 verify //3 objection                                                                              // 0 = Pending (default) 1  = objection 2= checked and processed  3 = cross chequed with employee data  4 = Awaiting for meeting 5= Approved
