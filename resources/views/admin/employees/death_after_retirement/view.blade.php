                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control  select2" disabled name="department"
                                                        style="width: 100%;"
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="retirementdate" id="r_date" value="{{$row->retirementdate}}"
                                                           class="form-control datemask"
                                                           data-inputmask-alias="datetime"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" disabled id="rel" name="relation[]"
                                                                style="width: 100%;" required>
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Branch</label>
                                                        <select  disabled class="form-control select2 bankbranches"
                                                                 name="branch[]"
                                                                 style="width: 100%;" required>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            @foreach(json_decode($doc->beneficiary_cnic1_img) as $key=>$row)
                                                <div class="col-sm-3">
                                                    <div class="mb-3">
                                                        <label for="formFile" class="form-label">Beneficiary
                                                            CNIC {{$key+1}}</label>
                                                        <a href="{{asset($row)}}" data-toggle="lightbox"
                                                           data-title="sample 1 - white" data-gallery="gallery">
                                                            <img src="{{asset($row)}}" class="img-fluid mb-2"
                                                                 alt="white sample"/>
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    ...
                                                    <a href="{{asset($doc->death_certificate)}}" data-toggle="lightbox"
                                                       data-title="sample 1 - white" data-gallery="gallery">
                                                        <img src="{{asset($doc->death_certificate)}}"
                                                             class="img-fluid mb-2" alt="white sample"/>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    <label for="formFile" class="form-label">Succession
                                                        Certificate</label>
                                                    <a href="{{asset($doc->succession_certificate)}}"
                                                       data-toggle="lightbox" data-title="sample 1 - white"
                                                       data-gallery="gallery">
                                                        <img src="{{asset($doc->succession_certificate)}}"
                                                             class="img-fluid mb-2" alt="white sample"/>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <a href="{{asset($doc->death_claim_farm)}}" data-toggle="lightbox"
                                                       data-title="sample 1 - white" data-gallery="gallery">
                                                        <img src="{{asset($doc->death_claim_farm)}}"
                                                             class="img-fluid mb-2" alt="white sample"/>
                                                    </a>

                                                </div>
                                            </div>
                                            @foreach(json_decode($doc->beneficiary_pension_sheet1_img) as $key=>$row)
                                                <div class="col-sm-3">
                                                    <div class="mb-3">
                                                        <label for="formFile" class="form-label">Pension Sheet of
                                                            Beneficiary {{$key+1}}</label>
                                                        <a href="{{asset($row)}}" data-toggle="lightbox"
                                                           data-title="sample 1 - white" data-gallery="gallery">
                                                            <img src="{{asset($row)}}" class="img-fluid mb-2"
                                                                 alt="white sample"/>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    <label for="formFile" class="form-label">Last Pay
                                                        Certificate</label>
                                                    <a href="{{asset($doc->lpc)}}" data-toggle="lightbox"
                                                       data-title="sample 1 - white" data-gallery="gallery">
                                                        <img src="{{asset($doc->lpc)}}" class="img-fluid mb-2"
                                                             alt="white sample"/>
                                                    </a>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    ...
                                                    <a href="{{asset($doc->bank_farm)}}" data-toggle="lightbox"
                                                       data-title="sample 1 - white" data-gallery="gallery">
                                                        <img src="{{asset($doc->bank_farm)}}" class="img-fluid mb-2"
                                                             alt="white sample"/>
                                                    </a>
