                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{route('entry.retirement')}}" style="margin-left: 30px;"  class="btn btn-primary btn-sm float-right">Add New Retirement Claim </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($employees as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td >{{$row1->heirname}}  </td >
                                        <td >{{$row1->relation_id}} </td >
                                        <td >{{$row1->bank->name}}  </td >
                                        <td >{{$row1->branch->branch_desc}}</td >
                                        <td >{{$row1->amount}} </td >
                                        <td>
                                            <!-- edit section -->
                                            <a href="{{route('retirement.edit' ,$row->id)}}"
                                               class="btn btn-sm btn-primary"
                                               title="edit">
                                                <i class="fa fa-pen"></i> Edit
                                            </a>
                                            <!-- view section -->
                                            <a href="{{route('retirement.view' ,$row->id)}}"
                                               class="btn btn-sm btn-primary"
                                               title="edit">
