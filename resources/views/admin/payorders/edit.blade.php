            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <!-- /.card -->
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"  name="recievername" value="{{$payorder->recievername}}" required
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="relation" required value="{{$payorder->relation}}"
                                                       class="form-control" placeholder="Relation With Employee"
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="recievercontact" value="{{$payorder->recievercontact}}" placeholder="03#########" required
                        ...
                        <button class="btn btn-primary" >Update Payorder</button>
                        </form>
                </div>
